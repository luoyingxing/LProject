...
//            Log.d("handle", "handle");
    ...
    private void initView(Context context) {
        ...
        rotateAnimation = (RotateAnimation) AnimationUtils.loadAnimation(context, R.anim.anim_loading_rotating);
        refreshingAnimation = (RotateAnimation) AnimationUtils.loadAnimation(context, R.anim.anim_loading_rotating);
        // 添加匀速转动动画
    ...
    public void refreshFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                refreshStateTextView.setText(R.string.app_name);
                refreshStateImageView.setBackgroundResource(R.mipmap.ic_launcher);
                break;
            case FAIL:
            default:
                // 刷新失败
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                loadStateTextView.setText(R.string.app_name);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        switch (ev.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mEvents == 0) {
                    if (pullDownY > 0 || canPullDown() && canPullDown && state != LOADING) {
                        // 可以下拉，正在加载时不能下拉
                        // 对实际滑动距离做缩小，造成用力拉的感觉
                    ...
                    } else if (pullUpY < 0 || canPullUp() && canPullUp && state != REFRESHING) {
                        // 可以上拉，正在刷新时不能上拉
